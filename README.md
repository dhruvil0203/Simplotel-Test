...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/dhruvil0203/grand-horizon-hotel-assistant.git
   cd grand-horizon-hotel-assistant
   ```
...
If you prefer managing backend and frontend in separate directories:

1. **Backend Setup**:
   ```bash
   cd hotel-assistant/server
   npm install
   npm run dev
